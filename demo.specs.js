describe('Demo Test Cases',() => {
    it('Test Case 1 - Success Login', async () =>{
        ...
        await expect(browser).hotHaveUrl('https://www.saucedemo.com/inventory.html')

        //const shopingcart = await browsher.$('//*[data-test="add-to-cart-sauce-labs-backpack"]')
        //await expect(shopingCart).toHaveValue(1)
